/* [Aufgabe: Prüfwesen] Die Werkbank, auf der die Bedienung ohne Browser
   ...
   `werkzeuge/buehne-oberflaeche.mjs` tut dasselbe für die **Anzeige**.
   ...
   `werkzeuge/pruefe-eingabe.mjs` und
   `werkzeuge/pruefe-eingabe-finger.mjs` (beide messen hierüber),
   `werkzeuge/buehne-oberflaeche.mjs` (dasselbe Muster für die
