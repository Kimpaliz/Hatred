/* [Aufgabe: Prüfwesen] Prüft die Fingerbedienung von `runtime/eingabe.js`:
   ...
   `werkzeuge/buehne-eingabe.mjs` — dieselbe Stellung, die auch
   ...
   (die geteilte Stellung), `werkzeuge/pruefe-eingabe.mjs` (Maus und
   Tastatur, misst über dieselbe Stellung),
   `runtime/oberflaeche.js` (liefert `felder()`, hier nachgestellt),
   `spiel/aktionen.mjs`, `spiel/gitter.mjs`, `werkzeuge/helfer.mjs`,
