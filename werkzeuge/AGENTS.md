...
- `miss-wandkontrast.mjs`, `miss-felddetail.mjs`, `miss-feldbauzeit.mjs`,
  `miss-flanke.mjs` (Abnahme W10: Abdeckung, Treppen, Sprung, Farbfamilie)
  und `topdown-vorschau.html` helfen beim Weltvergleich. `miss-bildabdruck.mjs` liefert die Prüfzahl über
