...
Bei mehreren Worktrees benennt der Leitstand den absoluten Pfad seiner
Koordinationskopie. Worktree-Kopien dieser Datei sind nicht automatisch
synchronisiert. Den Ablauf beschreibt [docs/AGENTEN.md](docs/AGENTEN.md).

| Bereich | Besitzer | Ziel | Seit |
| --- | --- | --- | --- |
| frei | frei | W10 und W11 sind gebaut und geprüft; niemand schreibt. | 12.09.2026 |
