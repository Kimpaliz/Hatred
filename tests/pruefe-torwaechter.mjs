/* [Aufgabe: Prüfwesen] Der Torwächter: das Wort, sein Fingerabdruck und
   ...
   `tests/buehne-browser.mjs` (das nachgestellte Handy samt
   mitschreibendem Blatt), `tests/helfer.mjs` (Behauptungen und
...
/* Was dieser Lauf gemessen hat - am Schluss gedruckt, damit jede Zahl
   ihren Befehl hat: `node tests/pruefe-torwaechter.mjs`. */
const messungen = [];
