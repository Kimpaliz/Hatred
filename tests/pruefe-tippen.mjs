/* [Aufgabe: Prüfwesen] Die Verdrahtung: Geht ein Tipp wirklich vom Blatt
   ...
   `tests/pruefe-app.mjs` baut denselben Ersatz, aber als eigene
   ...
   `spiel/zug.mjs`, `netz/sitzung.mjs`, `tests/helfer.mjs` und
...
import {
  ...
  punktVon, tippAndroid, tippSauber, torSchonOffen
...
/* Was dieser Lauf gemessen hat — am Schluss gedruckt, damit jede Zahl
   ihren Befehl hat: `node tests/pruefe-tippen.mjs`. */
const messungen = [];
