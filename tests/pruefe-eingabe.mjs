/* [Aufgabe: Prüfwesen] Prüft `runtime/eingabe.js` an **Maus und
   ...
   `tests/pruefe-eingabe-finger.mjs`. Das sind zwei Sachen und
   nicht dieselbe mit anderem Gerät. Die Stellung, auf der beide
   messen, steht in `tests/buehne-eingabe.mjs`.
   ...
   (die geteilte Stellung), `tests/pruefe-eingabe-finger.mjs` (der
   ...
   (`macheLauf`, `zustandsSumme`), `tests/helfer.mjs`,
