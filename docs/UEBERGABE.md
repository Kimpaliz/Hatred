...
worden. Sie ersetzt kein anderes Dokument: `CLAUDE.md` sagt, was das
Spiel ist, `docs/REGELN.md` sagt, wie hier gearbeitet wird,
...
`werkzeuge/pruefe-becken.mjs` blieb **53 von 53 Behauptungen grün** und
...
**F-B — `werkzeuge/pruefe-tippen.mjs` trägt fest eingetragene
...
**F-C — `werkzeuge/pruefe-lauf.mjs` scheitert flach in Runde 27, und
...
- **`werkzeuge/pruefe-app.mjs` hat 999 Zeilen** bei einer Grenze von
